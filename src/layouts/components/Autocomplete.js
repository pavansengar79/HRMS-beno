...
const categoryTitle = {
  ...
  adaptation: 'Adaptaion Report',
  retreadreports: 'Retread Reports',
  productlandingcost: 'Product Landing Cost',
  mailschedular: 'Mail Schedular',
  productvisibility: 'Product Visibility',
  notificationtrigger: 'Notification Trigger',
  survey: 'Survey',
  forecastdate: 'Forecast Date',
  maintenance: 'Maintenance',
  roimasters: 'Roi Masters',
  dealerchurn: 'Dealer Churn',
