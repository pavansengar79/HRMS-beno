...
const AddLeaveSidebar = props => {
  ...
  const onSubmit = data => {
    const employee = values.guests[0] || 'Unknown'
    ...
    >
      ...
      >
        <Typography variant='h5'>
          {store.selectedEvent !== null && store.selectedEvent.title.length ? 'Update Leave' : 'Add Leave'}
        </Typography>
...
export default AddLeaveSidebar
