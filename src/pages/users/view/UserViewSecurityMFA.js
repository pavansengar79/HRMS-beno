...
const UserViewSecurityMFA = ({ employee }) => {
  ...
  const [mfaEnabled, setMfaEnabled] = useState(employee?.userId?.mfaEnabled || current_user?.mfaEnabled || false)
  ...
  return (
    <Box sx={{ mt: 6 }}>
      ...
      <Typography sx={{ mb: 6, width: '100%', color: 'text.secondary' }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3 }}>
        ...
        <Button variant='outlined' color={mfaEnabled ? 'error' : 'primary'} onClick={handleToggle}>
