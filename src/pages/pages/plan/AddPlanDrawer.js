...
// POST /api/v1/plans
// Complete form matching backend schema exactly
...
const defaultValues = {
  ...
  price_annual: 0,
  seat_limit: 10,
  modules: ['6a44ef75d97f5fdfeaf1d57e', '6a44f1b6d97f5fdfeaf1d668', '6a44f1b6d97f5fdfeaf1d66a', '6a44f1b7d97f5fdfeaf1d66d'],
  features: [],
  status: 'Draft',
  is_custom: false,
  is_public: true
...
export default function AddPlanDrawer({ open, toggle, onSuccess }) {
  ...
  const handleModuleToggle = (moduleSlug) => {
    const currentModules = selectedModules || []
    if (currentModules.includes(moduleSlug)) {
      setValue('modules', currentModules.filter(m => m !== moduleSlug))
    } else {
      setValue('modules', [...currentModules, moduleSlug])
    }
  }
  ...
  return (
    ...
    >
      <Header>
        <Box>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>Create New Plan</Typography>
          <Typography variant='caption' color='text.secondary'>Define plan structure, pricing, and features</Typography>
        </Box>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
            <Alert severity='info' sx={{ fontSize: 12 }}>
              Plan features will be applied to all subscribed organisations. Module changes propagate automatically.
            </Alert>
                  ...
                  <Controller name='name' control={control}
                    ...
                    render={({ field }) => (
                      <CustomTextField
                        ...
                        fullWidth
                        label='Plan Name *'
                        placeholder='e.g., Professionals, Teams, Enterprise'
                        error={!!errors.name}
              ...
              <Grid container spacing={4}>
                  ...
                  <Controller name='price_monthly' control={control}
                    render={({ field }) => (
                      <CustomTextField
                        ...
                        helperText='Set to 0 or empty for custom pricing'
                      />
                    )} />
                </Grid>
                ...
                <Grid item xs={6}>
                  <Controller name='seat_limit' control={control}
                    rules={{ min: { value: 1, message: 'Minimum 1 seat' } }}
                    render={({ field }) => (
                      <CustomTextField
                        {...field}
                        fullWidth
                        ...
                        helperText={errors.seat_limit?.message || 'null = Unlimited'}
                      />
                    )} />
                </Grid>
            ...
            <Alert severity='warning' sx={{ fontSize: 11 }}>
              Module and feature changes will be synced to all subscribed organisations immediately.
            </Alert>
