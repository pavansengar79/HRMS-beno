...
const defaultValues = {
  eligibilityDataBOI: [{ group: [], rate: '', type: '', min: '', max: '', smartTyreRate: '', smartTyreRateType: 'INR' }]
}

const SmartTyre = ({ setTargetData, setExpanded, eligibilityData, groupList, productRunOn }) => {
  const {
    handleSubmit,
    watch,
    control,
  ...
  console.log('groupList in smarttyre', groupList)
      ...
      {groupFields.map((group, groupIndex) => (
        <Box key={group.id} mb={3} sx={{ border: '1px solid #999999', borderRadius: 1, padding: 5 }}>
          ...
          <Grid container columnSpacing={3} rowSpacing={3}>
            ...
            <Grid item xs={12} sm={3}>
              <Typography variant='body2'>1.1 Select Treel</Typography>
              <Controller
                name={`eligibilityDataBOI.${groupIndex}.smartTyres`}
                control={control}
                rules={{ required: true }}
                render={({ field: { value, onChange } }) => (
                  <Select
                    ...
                    displayEmpty
                    fullWidth
                    error={Boolean(errors.eligibilityDataBOI?.[groupIndex]?.smartTyres)}
                    id='select-multiple-checkbox'
                    multiple
                    value={value}
                    onChange={onChange}
              ...
              {errors.eligibilityDataBOI?.[groupIndex]?.group && (
                <Typography variant='body2' color='error'>
                  Select Treel is required
                </Typography>
              )}
            </Grid>

            <Grid item xs={12} sm={3}>
              <Typography variant='body2'>1.2 Amount</Typography>
              <Controller
                name={`eligibilityDataBOI.${groupIndex}.smartTyreRate`}
                control={control}
                rules={{ required: true }}
                render={({ field: { value, onChange } }) => (
                  <CustomTextField
                    ...
                    onKeyPress={handleKeyPress}
                    onChange={onChange}
                    error={Boolean(errors.groups?.smartTyreRate)}
                  />
                )}
              />
              {errors.eligibilityDataBOI?.[groupIndex]?.smartTyreRate && (
                <Typography variant='body2' color='error'>
                  Amount is required
                </Typography>
              )}
            ...
            <Grid item xs={12} sm={3}>
              <Typography variant='body2'>1.3 Discount Type</Typography>
              <Controller
                name={`eligibilityDataBOI.${groupIndex}.smartTyreRateType`}
                control={control}
                rules={{ required: true }}
                render={({ field: { value, onChange } }) => (
                  <CustomTextField
                    ...
                    value={value}
                    onChange={onChange}
                    error={Boolean(errors.groups?.smartTyreRateType)}
                    disabled={true}
                  />
                )}
              />
              {errors.eligibilityDataBOI?.[groupIndex]?.smartTyreRateType && (
                <Typography variant='body2' color='error'>
                  Rate or Amount is required
                </Typography>
              )}
            ...
            <Grid item xs={12} sm={3}>
              <Typography variant='body2'>4. Min & Max Quantity (Optional)</Typography>
              <Controller
                name={`eligibilityDataBOI.${groupIndex}.smartTyreMin`}
                control={control}
                rules={{ required: false }}
                render={({ field: { value, onChange } }) => (
                  <CustomTextField
              ...
              />
              <Controller
                name={`eligibilityDataBOI.${groupIndex}.smartTyreMax`}
                control={control}
                rules={{ required: false }}
                render={({ field: { value, onChange } }) => (
                  <CustomTextField
