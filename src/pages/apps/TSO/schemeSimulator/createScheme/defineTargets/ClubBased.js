...
// const ClubBased = ({ setTargetData, setExpanded }) => {
//   const {
//     handleSubmit,
//     watch,
//     control,
...
//                 <Grid item xs={12} sm={3}>
//                   <Typography variant='body2'>1. Select a club</Typography>
//                   <Controller
//                     name={`groups.${groupIndex}.slab.${slabIndex}.club`}
//                     control={control}
//                     rules={{ required: true }}
...
//                         value={value}
//                         onChange={onChange}
//                         error={Boolean(errors.groups?.[groupIndex]?.slab?.[slabIndex]?.club)}
//                       >
//                         <MenuItem value={'chairman'}>Chairman's</MenuItem>
//                       </Select>
//                     )}
//                   />

//                   {errors.groups?.[groupIndex]?.slab?.[slabIndex]?.club && (
//                     <Typography variant='body2' color='error'>
//                       Club is required
//                     </Typography>
//                   )}
...
//                   <Typography variant='body2'>3. Reward Amount</Typography>
//                   <Controller
...
const ClubBased = ({ setTargetData, setExpanded, eligibilityData, groupList, productRunOn }) => {
  const {
    handleSubmit,
    watch,
    control,
